...
public class TestSerializersXML {
...
//Client(String name,String ident,String email,String phone,String address,String birthday,String password,int clientCode,int numEquipments)            
            ...
            Client client2 = Client.getInstance("juan", "45464748X", "junam@gmail.cat", "666555555", "carrer kalea 3", "28-04-1987", "********", "1002", 1);
            Client client3 = Client.getInstance("jordi", "46474849X", "jordi@gmail.cat", "666555666", "carrer kalea 5", "10-06-1990", "********", "1003", 5);
            ...
            } catch (ServiceException | JAXBException ex) {
                System.out.println(ex);
            }
